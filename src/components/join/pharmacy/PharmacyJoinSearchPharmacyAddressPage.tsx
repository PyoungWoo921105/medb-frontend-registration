...
import { GetPharmacyPharmacyCoordinate } from "../../../services/pharmacy/GetPharmacyPharmacyCoordinate";
...
const PharmacyJoinSearchPharmacyAddressPage = observer((props: any) => {
  ...
  const handleComplete = (data: any) => {
    ...
    const GetPharmacyCoordinateFunction = async () => {
      const GetPharmacyPharmacyCoordinateData = {
      ...
      const response = await GetPharmacyPharmacyCoordinate(GetPharmacyPharmacyCoordinateData);
  ...
  const onClickGoButton = () => {
    PharmacyData.setPharmacyAddressData(BroadAddressData + " " + ExtraAddressData);
    PharmacyData.setPharmacyLocationData(PharmacyData.pharmacyCurrentLocationData);
    PharmacyData.setPharmacyCurrentLocationData(undefined);
...
export default PharmacyJoinSearchPharmacyAddressPage;
