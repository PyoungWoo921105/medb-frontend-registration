...
import { GetPharmacyManagerCoordinate } from "../../../services/pharmacy/GetPharmacyManagerCoordinate";
...
const PharmacyJoinSearchManagerAddressPage = observer((props: any) => {
  ...
  const handleComplete = (data: any) => {
    ...
    const GetPharmacyCoordinateFunction = async () => {
      const GetPharmacyManagerCoordinateData = {
      ...
      const response = await GetPharmacyManagerCoordinate(GetPharmacyManagerCoordinateData);
...
export default PharmacyJoinSearchManagerAddressPage;
