...
import { GetHospitalCoordinate } from "../../../services/hospital/GetHospitalCoordinate";
...
const HospitalJoinSearchBusinessAddressPage = observer((props: any) => {
  ...
  const handleComplete = (data: any) => {
    ...
    const GetHospitalCoordinateFunction = async () => {
      const GetHospitalCoordinateData = {
      ...
      const response = await GetHospitalCoordinate(GetHospitalCoordinateData);
