...
import { GetHospitalHospitalCoordinate } from "../../../services/hospital/GetHospitalHospitalCoordinate";
...
const HospitalJoinSearchHospitalAddressPage = observer((props: any) => {
  ...
  const handleComplete = (data: any) => {
    ...
    const GetHospitalCoordinateFunction = async () => {
      const GetHospitalHospitalCoordinateData = {
      ...
      const response = await GetHospitalHospitalCoordinate(GetHospitalHospitalCoordinateData);
...
export default HospitalJoinSearchHospitalAddressPage;
