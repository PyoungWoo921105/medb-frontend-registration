...
const DoctorAgreePage = observer((props: any) => {
  ...
  useEffect(() => {
    CommonData.setSelectType("doctor");
  ...
  async function callback(response: any) {
    ...
    if (success) {
      ...
      if (response.status === 201) {
        alert("본인인증 성공");
        if (CommonData.selectType === "doctor") {
          /*  */
          DoctorData.setCompanionDoctorNameData(CommonData.certificationData?.name);
          DoctorData.setCompanionDoctorBirthdayData(CommonData.certificationData?.birthday);
          DoctorData.setCompanionDoctorPhoneNumberData(CommonData.certificationData?.phoneNum);
          /*  */
        ...
        <ContainterContent className="ContainterContent">
          <SelectFrame className="SelectFrame">
            <SelectButtonComponent
              ...
              backgroundColor={CommonData.selectType === "doctor" ? "#00B264" : "transparent"}
              color={CommonData.selectType === "doctor" ? "#FFFFFF" : "#00B264"}
              margin="15px 15px 15px 15px"
            >
              의사
            </SelectButtonComponent>
...
export default DoctorAgreePage;
