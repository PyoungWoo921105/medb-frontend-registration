...
const CommonAgreePage = observer((props: any) => {
  ...
  const onClickSelectPharmacy = () => {
    if (CommonData.selectType === "pharmacy") {
      CommonData.setSelectType("");
    } else if (CommonData.selectType === "hospital") {
  ...
  const onClickGoButton = () => {
    if (CommonData.selectType === "hospital") {
      history.push({ pathname: "/hospital/join_1" });
    } else if (CommonData.selectType === "pharmacy") {
...
export default CommonAgreePage;
